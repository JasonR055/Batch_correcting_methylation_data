...
probes_typeI <- getProbeInfo(IlluminaHumanMethylation450kmanifest, type = "I")
probes_typeI$Type="typeI"
probes_typeII <- getProbeInfo(IlluminaHumanMethylation450kmanifest, type = "II")
...
save(probes, session, file=file.path(path_rdata, "450K_probe_tm_info.RData"))
